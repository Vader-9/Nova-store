...
function Footer(){
    ...
    return(
        <div className="w-full h-[700px] bg-black text-white pt-[10px] px-5 text-center flex flex-col    md:flex-row md:justify-between md:text-center md:h-[500px] md:w-full md:px-3 md:pt-[150px] gap-5">
